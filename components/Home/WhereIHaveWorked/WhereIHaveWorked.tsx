...
import Totle from "./Descriptions/Totle";
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Packetlabs Ltd"
            BarPosition={34}
            BarAvobePosition={1}
            DescriptionJob="Packetlabs"
          ...
          <CompanyButton
            ...
            DescriptionJob="Innowise"
            CompanyNameBackgroundColorGreen={[false, true, false, false, false]}
            setDescriptionJob={props.setDescriptionJob}
          />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={2}
            CompanyName="BrainSmiths Labs"
            BarPosition={122}
            BarAvobePosition={257}
            DescriptionJob="BrainSmiths"
