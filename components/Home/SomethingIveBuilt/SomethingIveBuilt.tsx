          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                ...
                <Link href={"https://beta.uni-fy.us/"}>
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  At <span className="text-AAsecondary">Uni-Fy</span>, we envision a future where <span className="text-AAsecondary">Web3</span> commerce is accessible, lucrative, and community-driven. Our platform is more than just a marketplace it is a revolutionary space that empowers both users and brands to thrive in the decentralized economy.
                </p>
              </div>
              <ul
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <GithubIcon link="https://github.com/lendon1114/unify-frontend" />
                <a href="" target={"_blank"} rel="noreferrer">
                  <ExternalLink
                    url={"https://beta.uni-fy.us/"}
                    router={router}
                  />
                </a>
              </div>
